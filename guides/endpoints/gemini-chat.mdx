...
description: "Access Gemini models on Upmore using the OpenAI-compatible chat completions format."
---

Upmore also provides Gemini models through the OpenAI-compatible `/v1/chat/completions` endpoint. Use the OpenAI SDK with Gemini model names — no Google SDK required.
