---
title: "GPT-5 Nano"
description: "OpenAI's GPT-5 Nano — ultra-lightweight, lowest-cost GPT-5 variant."
---

GPT-5 Nano is available through AnyFast via an OpenAI-compatible interface.
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/openai/gpt-5-nano"
>
