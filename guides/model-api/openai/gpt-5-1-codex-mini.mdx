...
description: "OpenAI's GPT-5.1 Codex Mini — compact code-optimized GPT-5.1."
---

GPT-5.1 Codex Mini is available through AnyFast via an OpenAI-compatible interface.
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/openai/gpt-5-1-codex-mini"
>
