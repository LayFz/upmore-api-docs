---
title: "GPT-5.4"
description: "OpenAI's GPT-5.4 — newest generation multimodal model."
---

GPT-5.4 is available through AnyFast via the OpenAI Responses API (`/v1/responses`).
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/openai/gpt-5-4"
>
