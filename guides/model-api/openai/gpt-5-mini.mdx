---
title: "GPT-5 Mini"
description: "OpenAI's GPT-5 Mini — compact, cost-effective variant of GPT-5."
---

GPT-5 Mini is available through AnyFast via an OpenAI-compatible interface.
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/openai/gpt-5-mini"
>
