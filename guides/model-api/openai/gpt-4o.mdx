---
title: "GPT-4o"
description: "OpenAI's GPT-4o — fast, multimodal flagship model with text, vision, and audio capabilities."
---

GPT-4o is available through AnyFast via an OpenAI-compatible interface.
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/openai/gpt-4o"
>
