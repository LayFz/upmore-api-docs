---
title: "GPT-5 Codex"
description: "OpenAI's GPT-5 Codex — code-optimized variant of GPT-5."
---

GPT-5 Codex is available through AnyFast via an OpenAI-compatible interface.
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/openai/gpt-5-codex"
>
