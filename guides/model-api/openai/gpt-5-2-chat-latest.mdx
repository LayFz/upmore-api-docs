...
description: "OpenAI's GPT-5.2 Chat Latest — latest chat-optimized GPT-5.2."
---

GPT-5.2 Chat Latest is available through AnyFast via the OpenAI Responses API (`/v1/responses`).
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/openai/gpt-5-2-chat-latest"
>
