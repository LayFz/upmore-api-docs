---
title: "GPT-5"
description: "OpenAI's GPT-5 — next-generation multimodal model with advanced reasoning."
---

GPT-5 is available through AnyFast via an OpenAI-compatible interface.
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/openai/gpt-5"
>
