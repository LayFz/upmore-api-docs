---
title: "GPT-5.2"
description: "OpenAI's GPT-5.2 — latest multimodal model with enhanced capabilities."
---

GPT-5.2 is available through AnyFast via the OpenAI Responses API (`/v1/responses`).
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/openai/gpt-5-2"
>
