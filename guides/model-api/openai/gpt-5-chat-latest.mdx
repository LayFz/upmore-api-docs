...
description: "OpenAI's GPT-5 Chat Latest — latest chat-optimized variant of GPT-5."
---

GPT-5 Chat Latest is available through AnyFast via an OpenAI-compatible interface.
...
|---|---|---|---|
| `model` | string | Yes | Must be `gpt-5-chat-latest` |
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/openai/gpt-5-chat-latest"
>
