---
title: "GPT-5.2 Chat"
description: "OpenAI's GPT-5.2 Chat — chat-optimized GPT-5.2 variant."
---

GPT-5.2 Chat is available through AnyFast via the OpenAI Responses API (`/v1/responses`).
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/openai/gpt-5-2-chat"
>
