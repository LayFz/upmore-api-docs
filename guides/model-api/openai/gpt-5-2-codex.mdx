---
title: "GPT-5.2 Codex"
description: "OpenAI's GPT-5.2 Codex — code-optimized GPT-5.2 variant."
---

GPT-5.2 Codex is available through Upmore via the OpenAI Responses API (`/v1/responses`).
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/openai/gpt-5-2-codex"
>
