...
description: "OpenAI's GPT-5 Codex Low — efficient code generation with GPT-5."
---

GPT-5 Codex Low is available through Upmore via an OpenAI-compatible interface.
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/openai/gpt-5-codex-low"
>
