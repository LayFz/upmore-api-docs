...
description: "OpenAI's GPT-5 Codex High — high-effort code generation with GPT-5."
---

GPT-5 Codex High is available through AnyFast via an OpenAI-compatible interface.
...
|---|---|---|---|
| `model` | string | Yes | Must be `gpt-5-codex-high` |
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/openai/gpt-5-codex-high"
>
