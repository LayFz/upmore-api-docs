...
description: "OpenAI's GPT-5.1 Chat Latest — latest chat-optimized GPT-5.1."
---

GPT-5.1 Chat Latest is available through AnyFast via an OpenAI-compatible interface.
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/openai/gpt-5-1-chat-latest"
>
