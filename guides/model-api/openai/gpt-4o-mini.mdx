---
title: "GPT-4o Mini"
description: "OpenAI's GPT-4o Mini — small, affordable, and capable multimodal model."
---

GPT-4o Mini is available through AnyFast via an OpenAI-compatible interface.
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/openai/gpt-4o-mini"
>
