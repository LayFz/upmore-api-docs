---
title: "GPT-4.1"
description: "OpenAI's GPT-4.1 — fast, capable multimodal model with improved instruction following."
---

GPT-4.1 is available through AnyFast via an OpenAI-compatible interface.
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/openai/gpt-4-1"
>
