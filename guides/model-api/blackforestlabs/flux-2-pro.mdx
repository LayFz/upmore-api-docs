---
title: "FLUX.2 [pro]"
description: "FLUX.2 [pro] text-to-image model by Black Forest Labs via Upmore API."
---

FLUX.2 [pro] is an advanced text-to-image generation model from Black Forest Labs, available through Upmore. It supports up to 4MP resolution and multi-reference image consistency. The API is **synchronous** — it returns the generated image directly as base64-encoded data.
