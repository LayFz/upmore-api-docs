---
title: "MiniMax M2.5"
description: "MiniMax M2.5 chat model via AnyFast OpenAI-compatible API. Fast, capable, and easy to integrate."
---

MiniMax M2.5 is a chat model available through AnyFast via an OpenAI-compatible interface.
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/minimax/minimax-m2-5"
>
