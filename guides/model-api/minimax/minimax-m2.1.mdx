---
title: "MiniMax M2.1"
description: "MiniMax M2.1 chat model via AnyFast OpenAI-compatible API. Fast, capable, and easy to integrate."
---

MiniMax M2.1 is a chat model available through AnyFast via an OpenAI-compatible interface.
...
|---|---|---|---|
| `model` | string | Yes | Must be `minimax-m2.1` |
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/minimax/minimax-m2.1"
>
