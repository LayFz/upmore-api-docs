---
title: "MiniMax M2.1"
description: "MiniMax M2.1 chat model via Upmore OpenAI-compatible API. Fast, capable, and easy to integrate."
---

MiniMax M2.1 is a chat model available through Upmore via an OpenAI-compatible interface.
