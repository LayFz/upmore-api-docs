---
title: "MiniMax M2.5"
description: "MiniMax M2.5 chat model via Upmore OpenAI-compatible API. Fast, capable, and easy to integrate."
---

MiniMax M2.5 is a chat model available through Upmore via an OpenAI-compatible interface.
