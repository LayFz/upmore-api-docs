---
title: "GLM-5.1"
description: "Zhipu AI's GLM-5.1 chat model via OpenAI-compatible API. The latest and most capable GLM model."
---

GLM-5.1 is Zhipu AI's latest flagship model, available through AnyFast via an OpenAI-compatible interface. It delivers state-of-the-art performance in reasoning, coding, and conversational tasks.
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/zhipu/glm-5.1"
>
