---
title: "GLM-4-7"
description: "Zhipu AI's GLM-4-7 chat model via OpenAI-compatible API. Fast, capable, and easy to integrate."
---

GLM-4-7 is Zhipu AI's chat model, available through AnyFast via an OpenAI-compatible interface. It delivers strong reasoning and conversational capabilities.
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/zhipu/glm-4.7"
>
