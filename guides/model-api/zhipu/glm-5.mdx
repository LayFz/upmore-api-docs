---
title: "GLM-5"
description: "Zhipu AI's GLM-5 chat model via OpenAI-compatible API. A powerful next-generation GLM model."
---

GLM-5 is Zhipu AI's next-generation model, available through AnyFast via an OpenAI-compatible interface. It delivers strong performance in reasoning, coding, and conversational tasks.
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/zhipu/glm-5"
>
