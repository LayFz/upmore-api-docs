...
Gemini 2.5 Flash Image is Google's image generation model, available through Upmore via the native Gemini API. It can generate images from text prompts and edit existing images using a reference photo.
...
```bash cURL
curl "https://api.upmore.net/v1beta/models/gemini-2.5-flash-image:generateContent?key=YOUR_API_KEY" \
...
url = "https://api.upmore.net/v1beta/models/gemini-2.5-flash-image:generateContent"
