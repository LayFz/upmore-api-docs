...
Gemini 3.1 Flash Lite Preview is Google's lightweight and efficient language model, available through Upmore via the native Gemini API. Optimized for speed and cost-effectiveness while maintaining strong language understanding.
...
```bash cURL
curl "https://api.upmore.net/v1beta/models/gemini-3.1-flash-lite-preview:generateContent?key=YOUR_API_KEY" \
...
url = "https://api.upmore.net/v1beta/models/gemini-3.1-flash-lite-preview:generateContent"
