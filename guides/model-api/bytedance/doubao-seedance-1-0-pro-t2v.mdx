...
description: "ByteDance's Seedance 1.0 Pro text-to-video model. Generate videos from text prompts."
---

Seedance 1.0 Pro t2v is a text-to-video generation model from ByteDance's Seedance series, available through Upmore API.
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/bytedance/doubao-seedance-1-0-pro-250528-t2v"
>
