---
title: "GLM-4-7"
description: "Zhipu AI's GLM-4-7 chat model via ByteDance via OpenAI-compatible API. Fast, capable, and easy to integrate."
---

GLM-4-7 is a chat model available through AnyFast via an OpenAI-compatible interface. Zhipu AI's GLM-4-7 chat model via ByteDance.
...
|---|---|---|---|
| `model` | string | Yes | Must be `glm-4-7-251222` |
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/bytedance/glm-4-7-251222"
>
