---
title: "DeepSeek V3.2"
description: "DeepSeek V3.2 chat model via ByteDance via OpenAI-compatible API. Fast, capable, and easy to integrate."
---

DeepSeek V3.2 is a chat model available through AnyFast via an OpenAI-compatible interface. DeepSeek V3.2 chat model via ByteDance.
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/bytedance/deepseek-v3-2-251201"
>
