---
title: "Volc Asset Management"
description: "Manage media assets (images, videos, audio) for Seedance video generation via AnyFast API."
---

Volc Asset Management lets you upload and organize media resources for use with Seedance video generation. Once uploaded, assets are referenced by ID (`Asset://<ID>`) in Seedance requests instead of public URLs.
