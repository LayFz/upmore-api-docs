...
description: "Manage image assets for Seedance video generation via AnyFast API."
---

Seedance Asset Management lets you upload and organize image assets for use with Seedance video generation. Once uploaded, assets are referenced by ID (`Asset://<ID>`) in Seedance requests instead of public URLs.
...
- **Direct integration** — Use `Asset://<ID>` directly in Seedance `image_url` fields
