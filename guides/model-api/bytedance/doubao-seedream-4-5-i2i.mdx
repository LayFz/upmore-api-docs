...
description: "ByteDance Seedream 4.5 image-to-image model. Generate images from reference images with text prompts."
---

Seedream 4.5 i2i is an image-to-image generation model from ByteDance's Seedream series, available through AnyFast API.
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/bytedance/doubao-seedream-4-5-251128-i2i"
>
