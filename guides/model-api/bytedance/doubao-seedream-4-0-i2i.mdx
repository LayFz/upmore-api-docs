...
description: "ByteDance Seedream 4.0 image-to-image model. Generate images from reference images with text prompts."
---

Seedream 4.0 i2i is an image-to-image generation model from ByteDance's Seedream series, available through Upmore API.
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/bytedance/doubao-seedream-4-0-250828-i2i"
>
