...
Seedance 2.0 Fast is ByteDance's latest video generation model available through AnyFast API. It supports text-to-video, image-to-video, multimodal reference input, video editing, video extension, and synchronized audio generation.
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/bytedance/seedance-2-0-fast"
>
