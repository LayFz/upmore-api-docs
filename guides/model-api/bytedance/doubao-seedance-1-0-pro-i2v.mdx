...
Seedance 1.0 Pro i2v is an image-to-video generation model from ByteDance's Seedance series, available through AnyFast API. Use reference images as first frame (and last frame) to generate videos.
