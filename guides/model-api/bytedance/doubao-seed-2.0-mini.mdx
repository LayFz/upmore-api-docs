...
description: "ByteDance's compact Seed 2.0 Mini model, designed for high-throughput scenarios."
---

Doubao Seed 2.0 Mini is a chat model available through Upmore via an OpenAI-compatible interface. ByteDance's compact Seed 2.0 Mini model, designed for high-throughput scenarios.
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/bytedance/doubao-seed-2.0-mini"
>
