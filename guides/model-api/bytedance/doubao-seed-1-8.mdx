...
description: "ByteDance's advanced Seed 1.8 chat model via OpenAI-compatible API. Fast, capable, and easy to integrate."
---

Doubao Seed 1.8 is a chat model available through AnyFast via an OpenAI-compatible interface. ByteDance's advanced Seed 1.8 chat model.
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/bytedance/doubao-seed-1-8-251228"
>
