...
description: "ByteDance's lightweight chat model via OpenAI-compatible API. Fast, capable, and easy to integrate."
---

Doubao Seed 1.6 Lite is a chat model available through AnyFast via an OpenAI-compatible interface. ByteDance's lightweight chat model.
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/bytedance/doubao-seed-1-6-lite-251015"
>
