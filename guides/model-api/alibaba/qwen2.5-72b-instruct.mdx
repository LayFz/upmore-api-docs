...
description: "Qwen2.5-72B-Instruct chat model via Alibaba via AnyFast OpenAI-compatible API. Fast, capable, and easy to integrate."
---

Qwen2.5-72B-Instruct is a chat model available through AnyFast via an OpenAI-compatible interface.
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/alibaba/qwen2.5-72b-instruct"
>
