...
description: "Qwen2.5-72B-Instruct chat model via Alibaba via Upmore OpenAI-compatible API. Fast, capable, and easy to integrate."
---

Qwen2.5-72B-Instruct is a chat model available through Upmore via an OpenAI-compatible interface.
