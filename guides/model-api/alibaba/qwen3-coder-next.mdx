...
description: "Qwen3-Coder-Next chat model via Alibaba via Upmore OpenAI-compatible API. Fast, capable, and easy to integrate."
---

Qwen3-Coder-Next is a chat model available through Upmore via an OpenAI-compatible interface.
