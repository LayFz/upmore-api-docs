...
description: "Qwen3-Next-80B-A3B-Instruct chat model via Alibaba via Upmore OpenAI-compatible API. Fast, capable, and easy to integrate."
---

Qwen3-Next-80B-A3B-Instruct is a chat model available through Upmore via an OpenAI-compatible interface.
