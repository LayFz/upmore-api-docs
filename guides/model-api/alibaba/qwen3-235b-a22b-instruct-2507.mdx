...
description: "Qwen3-235B-A22B-Instruct-2507 chat model via Alibaba via Upmore OpenAI-compatible API. Fast, capable, and easy to integrate."
---

Qwen3-235B-A22B-Instruct-2507 is a chat model available through Upmore via an OpenAI-compatible interface.
