...
description: "Qwen3-235B-A22B-Instruct-2507 chat model via Alibaba via AnyFast OpenAI-compatible API. Fast, capable, and easy to integrate."
---

Qwen3-235B-A22B-Instruct-2507 is a chat model available through AnyFast via an OpenAI-compatible interface.
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/alibaba/qwen3-235b-a22b-instruct-2507"
>
