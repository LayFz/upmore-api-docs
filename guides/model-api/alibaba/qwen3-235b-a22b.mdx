...
description: "Qwen3-235B-A22B chat model via Alibaba via Upmore OpenAI-compatible API. Fast, capable, and easy to integrate."
---

Qwen3-235B-A22B is a chat model available through Upmore via an OpenAI-compatible interface.
