...
description: "Qwen3.5-397B-A17B chat model via Alibaba via Upmore OpenAI-compatible API. Fast, capable, and easy to integrate."
---

Qwen3.5-397B-A17B is a chat model available through Upmore via an OpenAI-compatible interface.
