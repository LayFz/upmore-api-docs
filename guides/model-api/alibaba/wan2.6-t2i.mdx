---
title: "Wan2.6 T2I"
description: "Wan2.6 T2I text-to-image model via Alibaba via Upmore API."
---

Wan2.6 T2I is a text-to-image generation model available through Upmore. The API is **synchronous** — it polls the upstream task automatically and returns the final image URL directly.
