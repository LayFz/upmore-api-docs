...
description: "Qwen3-30B-A3B-Instruct-2507 chat model via Alibaba via Upmore OpenAI-compatible API. Fast, capable, and easy to integrate."
---

Qwen3-30B-A3B-Instruct-2507 is a chat model available through Upmore via an OpenAI-compatible interface.
