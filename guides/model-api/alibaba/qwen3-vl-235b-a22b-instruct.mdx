...
description: "Qwen3-VL-235B-A22B-Instruct chat model via Alibaba via Upmore OpenAI-compatible API. Fast, capable, and easy to integrate."
---

Qwen3-VL-235B-A22B-Instruct is a chat model available through Upmore via an OpenAI-compatible interface.
