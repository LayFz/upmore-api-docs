...
description: "Qwen2.5-VL-7B-Instruct chat model via Alibaba via Upmore OpenAI-compatible API. Fast, capable, and easy to integrate."
---

Qwen2.5-VL-7B-Instruct is a chat model available through Upmore via an OpenAI-compatible interface.
