---
title: "Qwen3-32B"
description: "Qwen3-32B chat model via Alibaba via Upmore OpenAI-compatible API. Fast, capable, and easy to integrate."
---

Qwen3-32B is a chat model available through Upmore via an OpenAI-compatible interface.
