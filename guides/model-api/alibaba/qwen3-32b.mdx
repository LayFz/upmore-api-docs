---
title: "Qwen3-32B"
description: "Qwen3-32B chat model via Alibaba via AnyFast OpenAI-compatible API. Fast, capable, and easy to integrate."
---

Qwen3-32B is a chat model available through AnyFast via an OpenAI-compatible interface.
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/alibaba/qwen3-32b"
>
