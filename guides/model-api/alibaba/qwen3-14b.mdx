---
title: "Qwen3-14B"
description: "Qwen3-14B chat model via Alibaba via Upmore OpenAI-compatible API. Fast, capable, and easy to integrate."
---

Qwen3-14B is a chat model available through Upmore via an OpenAI-compatible interface.
