...
description: "Qwen3-VL-235B-A22B-Thinking chat model via Alibaba via AnyFast OpenAI-compatible API. Fast, capable, and easy to integrate."
---

Qwen3-VL-235B-A22B-Thinking is a chat model available through AnyFast via an OpenAI-compatible interface.
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/alibaba/qwen3-vl-235b-a22b-thinking"
>
