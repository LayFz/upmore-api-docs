...
description: "Qwen Image Plus text-to-image model via Alibaba via Upmore API."
---

Qwen Image Plus is a text-to-image generation model available through Upmore. The API is **synchronous** — it polls the upstream task automatically and returns the final image URL directly.
