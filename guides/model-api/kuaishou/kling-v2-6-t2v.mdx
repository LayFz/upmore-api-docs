...
Kling 2.6 t2v is a text-to-video generation model from Kuaishou's Kling series, available through AnyFast API. Create videos from text descriptions with customizable camera movements, multi-shot storyboarding, and optional sound generation.
