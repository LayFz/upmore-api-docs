---
title: "Kling 1.5 i2v"
description: "Kuaishou's Kling 1.5 i2v model. Generate videos from reference images with camera control, motion brush, and multi-shot storyboarding."
---

Kling 1.5 i2v is an image-to-video generation model from Kuaishou's Kling series, available through Upmore API. Transform static images into dynamic videos with customizable camera movements, motion brushes, and multi-shot storyboarding.
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/kuaishou/kling-v1-5-i2v"
>
  View the interactive API playground for Kling 1.5 i2v.
</Card>
