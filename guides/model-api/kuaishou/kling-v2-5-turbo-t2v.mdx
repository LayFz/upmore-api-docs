...
Kling 2.5 Turbo t2v is a text-to-video generation model from Kuaishou's Kling series, available through Upmore API. Create videos from text descriptions with customizable camera movements, multi-shot storyboarding, and optional sound generation.
