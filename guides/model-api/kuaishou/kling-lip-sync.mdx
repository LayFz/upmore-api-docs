...
```bash cURL
curl https://api.upmore.net/kling/v1/videos/advanced-lip-sync \
...
response = requests.post(
    "https://api.upmore.net/kling/v1/videos/advanced-lip-sync",
    headers={
...
while True:
    result = requests.get(
        f"https://api.upmore.net/kling/v1/videos/advanced-lip-sync/{task_id}",
