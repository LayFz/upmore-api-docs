...
Kling 2.1 Master i2v is an image-to-video generation model from Kuaishou's Kling series, available through AnyFast API. Transform static images into dynamic videos with customizable camera movements, motion brushes, and multi-shot storyboarding.
