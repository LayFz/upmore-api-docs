...
Kling 2.5 Turbo i2v is an image-to-video generation model from Kuaishou's Kling series, available through AnyFast API. Transform static images into dynamic videos with customizable camera movements, motion brushes, and multi-shot storyboarding.
