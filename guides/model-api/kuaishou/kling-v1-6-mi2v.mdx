...
Kling 1.6 mi2v is a multi-image-to-video generation model from Kuaishou's Kling series, available through Upmore API. Upload up to 4 reference images and combine them with a text prompt to generate a cohesive video featuring all the referenced subjects.
...
```bash cURL
curl https://api.upmore.net/kling/v1/videos/multi-image2video \
...
response = requests.post(
    "https://api.upmore.net/kling/v1/videos/multi-image2video",
    headers={
