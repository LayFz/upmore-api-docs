---
title: "Kimi-K2.5"
description: "Kimi-K2.5 chat model via MoonShot via Upmore OpenAI-compatible API. Fast, capable, and easy to integrate."
---

Kimi-K2.5 is a chat model by MoonShot (月之暗面), available through Upmore via an OpenAI-compatible interface.
