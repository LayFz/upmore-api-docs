---
title: "Kimi-K2.5"
description: "Kimi-K2.5 chat model via MoonShot via AnyFast OpenAI-compatible API. Fast, capable, and easy to integrate."
---

Kimi-K2.5 is a chat model by MoonShot (月之暗面), available through AnyFast via an OpenAI-compatible interface.
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/moonshot/kimi-k2.5"
>
