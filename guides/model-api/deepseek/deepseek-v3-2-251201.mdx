---
title: "DeepSeek V3.2"
description: "DeepSeek V3.2 chat model via AnyFast OpenAI-compatible API. Fast, capable, and easy to integrate."
---

DeepSeek V3.2 is a powerful chat model available through AnyFast via an OpenAI-compatible interface. It excels at complex reasoning, coding, and multi-turn conversations.
...
|---|---|---|---|
| `model` | string | Yes | Must be `deepseek-v3-2-251201` |
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/deepseek/deepseek-v3-2-251201"
>
