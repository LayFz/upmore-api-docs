---
title: "DeepSeek V3.2"
description: "DeepSeek V3.2 chat model via Upmore OpenAI-compatible API. Fast, capable, and easy to integrate."
---

DeepSeek V3.2 is a powerful chat model available through Upmore via an OpenAI-compatible interface. It excels at complex reasoning, coding, and multi-turn conversations.
