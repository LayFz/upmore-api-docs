---
title: "DeepSeek V3.2"
description: "DeepSeek V3.2 via AnyFast OpenAI-compatible API. Fast, capable, and easy to integrate."
---

DeepSeek V3.2 is available through AnyFast via an OpenAI-compatible interface. It excels at complex reasoning, coding, and multi-turn conversations.
