...
description: "DeepSeek V3.2 Exp via Upmore OpenAI-compatible API. Fast, capable, and easy to integrate."
---

DeepSeek V3.2 Exp is available through Upmore via an OpenAI-compatible interface. It excels at complex reasoning, coding, and multi-turn conversations.
