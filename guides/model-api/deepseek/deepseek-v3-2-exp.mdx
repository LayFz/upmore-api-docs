...
description: "DeepSeek V3.2 Exp via AnyFast OpenAI-compatible API. Fast, capable, and easy to integrate."
---

DeepSeek V3.2 Exp is available through AnyFast via an OpenAI-compatible interface. It excels at complex reasoning, coding, and multi-turn conversations.
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/deepseek/deepseek-v3-2-exp"
>
