...
description: "Grok 4 Fast Reasoning by xAI via Upmore OpenAI-compatible API. Grok 4 with reasoning."
---

Grok 4 Fast Reasoning is available through Upmore via an OpenAI-compatible interface. Grok 4 with reasoning.
