...
description: "Grok 4 Fast Reasoning by xAI via AnyFast OpenAI-compatible API. Grok 4 with reasoning."
---

Grok 4 Fast Reasoning is available through AnyFast via an OpenAI-compatible interface. Grok 4 with reasoning.
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/xai/grok-4-fast-reasoning"
>
