...
description: "Grok 4 Fast Non-Reasoning by xAI via Upmore OpenAI-compatible API. Grok 4 without reasoning."
---

Grok 4 Fast Non-Reasoning is available through Upmore via an OpenAI-compatible interface. Grok 4 without reasoning.
