...
description: "Grok 4 Fast Non-Reasoning by xAI via AnyFast OpenAI-compatible API. Grok 4 without reasoning."
---

Grok 4 Fast Non-Reasoning is available through AnyFast via an OpenAI-compatible interface. Grok 4 without reasoning.
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/xai/grok-4-fast-non-reasoning"
>
