---
title: "Grok 3"
description: "Grok 3 by xAI via AnyFast OpenAI-compatible API. xAI most capable model."
---

Grok 3 is available through AnyFast via an OpenAI-compatible interface. xAI most capable model.
