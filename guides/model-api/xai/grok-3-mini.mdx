---
title: "Grok 3 Mini"
description: "Grok 3 Mini by xAI via Upmore OpenAI-compatible API. Fast and lightweight."
---

Grok 3 Mini is available through Upmore via an OpenAI-compatible interface. Fast and lightweight.
