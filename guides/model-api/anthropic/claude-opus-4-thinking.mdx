...
|---|---|---|---|
| `model` | string | Yes | Must be `claude-opus-4-20250514-thinking` |
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/anthropic/claude-opus-4-20250514-thinking"
>
