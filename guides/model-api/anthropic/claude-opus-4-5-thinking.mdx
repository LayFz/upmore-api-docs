...
description: "Anthropic's Claude Opus 4.5 with extended thinking enabled. The ultimate reasoning model for the most complex problems."
---

Claude Opus 4.5 Thinking is the extended thinking variant of Claude Opus 4.5, available through Upmore via an OpenAI-compatible interface. It combines Opus 4.5's unmatched intelligence with step-by-step internal reasoning enabled by default, delivering the highest accuracy available on the most demanding tasks including advanced mathematics, scientific research, and complex architectural decisions.
...
|---|---|---|---|
| `model` | string | Yes | Must be `claude-opus-4-5-20251101-thinking` |
...
<Card
  title="API Reference"
  icon="code"
  href="/api-reference/model-api/anthropic/claude-opus-4-5-20251101-thinking"
>
