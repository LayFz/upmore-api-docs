---
title: "Quickstart"
description: "Start making API calls to AnyFast in minutes."
icon: "rocket"
---
...
<Tip>
  Newly created tokens default to **Direct → Aggregate** group priority — requests hit the Direct (direct-connect) channel first, falling back to Aggregate (premium) if needed.
</Tip>
