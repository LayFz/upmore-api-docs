---
title: "Wan2.6 T2I"
description: "通过 AnyFast API 调用阿里巴巴 Wan2.6 T2I 文生图模型。"
---

Wan2.6 T2I 是通过 AnyFast 提供的文生图模型。API 为**同步调用** — 自动轮询上游异步任务，直接返回最终图片 URL。
...
<Card
  title="API 参考"
  icon="code"
  href="/zh/api-reference/model-api/alibaba/wan2-6-t2i"
>
