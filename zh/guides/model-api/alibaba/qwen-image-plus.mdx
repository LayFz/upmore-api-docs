...
description: "通过 Upmore API 调用阿里巴巴 Qwen Image Plus 文生图模型。"
---

Qwen Image Plus 是通过 Upmore 提供的文生图模型。API 为**同步调用** — 自动轮询上游异步任务，直接返回最终图片 URL。
...
<Card
  title="API 参考"
  icon="code"
  href="/zh/api-reference/model-api/alibaba/qwen-image-plus"
>
