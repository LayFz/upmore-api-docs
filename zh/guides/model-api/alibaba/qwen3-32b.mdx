---
title: "Qwen3-32B"
description: "通过 AnyFast OpenAI 兼容接口调用Qwen3-32B 对话模型（阿里巴巴渠道），快速、强大且易于集成。"
---

Qwen3-32B 是通过 AnyFast 以 OpenAI 兼容接口提供的对话模型。
...
<Card
  title="API 参考"
  icon="code"
  href="/zh/api-reference/model-api/alibaba/qwen3-32b"
>
