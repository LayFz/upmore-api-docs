...
GPT Image 1.5 是 OpenAI 基于 GPT-5 架构的最新图像生成模型，通过 Upmore API 提供服务。相比 GPT Image 1 速度提升 4 倍、成本降低 20%，文字渲染和编辑精度显著提升。
...
<Card
  title="API 参考"
  icon="code"
  href="/zh/api-reference/model-api/openai/gpt-image-1-5"
>
