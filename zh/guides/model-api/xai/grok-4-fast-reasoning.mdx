...
description: "通过 AnyFast API 调用 xAI Grok 4 Fast Reasoning 模型。Grok 4 推理版。"
---

Grok 4 Fast Reasoning 是 xAI 推出的语言模型，通过 AnyFast 提供。Grok 4 推理版。
...
<Card
  title="API 参考"
  icon="code"
  href="/zh/api-reference/model-api/xai/grok-4-fast-reasoning"
>
