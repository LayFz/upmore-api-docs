...
Seedance 1.0 Pro Fast 文生视频 是字节跳动 Seedance 系列的文生视频模型，通过 AnyFast API 提供服务。
...
<Card
  title="API 参考"
  icon="code"
  href="/zh/api-reference/model-api/bytedance/doubao-seedance-1-0-pro-fast-251015-t2v"
>
