---
title: "DeepSeek V3.2"
description: "通过 OpenAI 兼容接口调用DeepSeek V3.2 对话模型（字节跳动渠道），快速、强大且易于集成。"
---

DeepSeek V3.2 是通过 AnyFast 以 OpenAI 兼容接口提供的对话模型。DeepSeek V3.2 对话模型（字节跳动渠道）。
...
<Card
  title="API 参考"
  icon="code"
  href="/zh/api-reference/model-api/bytedance/deepseek-v3-2-251201"
>
