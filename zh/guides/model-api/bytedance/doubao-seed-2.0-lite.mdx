...
豆包 Seed 2.0 Lite 是通过 AnyFast OpenAI 兼容接口提供的对话模型。字节跳动 Seed 2.0 Lite 轻量模型，性价比高，适合日常任务。
...
<Card
  title="API 参考"
  icon="code"
  href="/zh/api-reference/model-api/bytedance/doubao-seed-2.0-lite"
>
  查看 豆包 Seed 2.0 Lite 的交互式 API 文档。
</Card>
