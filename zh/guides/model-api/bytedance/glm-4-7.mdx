---
title: "GLM-4-7"
description: "通过 OpenAI 兼容接口调用智谱 GLM-4-7 对话模型（字节跳动渠道），快速、强大且易于集成。"
---

GLM-4-7 是通过 AnyFast 以 OpenAI 兼容接口提供的对话模型。智谱 GLM-4-7 对话模型（字节跳动渠道）。
...
| 参数 | 类型 | 必填 | 说明 |
|---|---|---|---|
| `model` | string | 是 | 固定为 `glm-4-7-251222` |
...
<Card
  title="API 参考"
  icon="code"
  href="/zh/api-reference/model-api/bytedance/glm-4-7-251222"
>
