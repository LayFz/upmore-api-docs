...
豆包 Seed 2.0 Code 是通过 AnyFast OpenAI 兼容接口提供的对话模型。字节跳动 Seed 2.0 Code 编程模型，专为代码生成与理解优化。
...
<Card
  title="API 参考"
  icon="code"
  href="/zh/api-reference/model-api/bytedance/doubao-seed-2.0-code"
>
  查看 豆包 Seed 2.0 Code 的交互式 API 文档。
</Card>
