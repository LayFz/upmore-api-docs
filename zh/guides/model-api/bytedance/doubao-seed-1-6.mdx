...
豆包 Seed 1.6 是通过 AnyFast 以 OpenAI 兼容接口提供的对话模型。字节跳动均衡性能对话模型。
...
<Card
  title="API 参考"
  icon="code"
  href="/zh/api-reference/model-api/bytedance/doubao-seed-1-6-251015"
>
  查看 豆包 Seed 1.6 的交互式 API Playground。
</Card>
