...
Seedance 1.0 Lite 文生视频 是字节跳动 Seedance 系列的视频生成模型，通过 Upmore API 提供服务。使用多模态内容格式，从文本提示词和参考图片创建视频。
...
<Card
  title="API 参考"
  icon="code"
  href="/zh/api-reference/model-api/bytedance/doubao-seedance-1-0-lite-t2v-250428"
>
