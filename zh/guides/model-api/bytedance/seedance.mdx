---
title: "Seedance"
description: "通过 AnyFast API 调用字节跳动 Seedance 视频生成模型，支持多模态参考、视频编辑、延长、有声视频、联网搜索增强。"
---

Seedance 是字节跳动最新的视频生成模型，通过 AnyFast API 提供。支持文生视频、图生视频、多模态参考输入、视频编辑、视频延长及同步音频生成。
...
<Card
  title="API 参考"
  icon="code"
  href="/zh/api-reference/model-api/bytedance/seedance"
>
  查看 Seedance 的交互式 API 文档。
</Card>
