...
豆包 Seed 2.0 Pro 是通过 AnyFast OpenAI 兼容接口提供的对话模型。字节跳动 Seed 2.0 Pro 旗舰模型，推理能力最强。
...
<Card
  title="API 参考"
  icon="code"
  href="/zh/api-reference/model-api/bytedance/doubao-seed-2.0-pro"
>
  查看 豆包 Seed 2.0 Pro 的交互式 API 文档。
</Card>
