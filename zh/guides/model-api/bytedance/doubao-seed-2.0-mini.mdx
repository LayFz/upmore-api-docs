...
豆包 Seed 2.0 Mini 是通过 AnyFast OpenAI 兼容接口提供的对话模型。字节跳动 Seed 2.0 Mini 紧凑模型，适合高吞吐场景。
...
<Card
  title="API 参考"
  icon="code"
  href="/zh/api-reference/model-api/bytedance/doubao-seed-2.0-mini"
>
  查看 豆包 Seed 2.0 Mini 的交互式 API 文档。
</Card>
