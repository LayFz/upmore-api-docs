...
Seedance 1.0 Pro 图生视频 是字节跳动 Seedance 系列的图生视频模型，通过 Upmore API 提供服务。使用参考图片作为首帧（和尾帧）生成视频。
...
<Card
  title="API 参考"
  icon="code"
  href="/zh/api-reference/model-api/bytedance/doubao-seedance-1-0-pro-250528-i2v"
>
