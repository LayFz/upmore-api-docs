...
description: "通过 AnyFast API 管理 Seedance 视频生成所需的图片素材。"
---

Seedance 2.0 素材管理让你可以上传和组织图片素材，供 Seedance 2.0 视频生成使用。上传后，在 Seedance 2.0 请求中通过素材 ID（`Asset://<ID>`）引用素材，无需使用公开 URL。
...
- **直接集成** — 在 Seedance 2.0 的 `image_url` 字段中直接使用 `Asset://<ID>`
