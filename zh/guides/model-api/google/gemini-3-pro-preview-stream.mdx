...
Gemini 3 Pro Preview (Stream) 提供基于 Google Gemini 3 Pro Preview 模型的流式文本生成服务，通过 Upmore 代理访问。响应通过 Server-Sent Events (SSE) 实时传输。
...
<Card
  title="API 参考"
  icon="code"
  href="/zh/api-reference/model-api/google/gemini-3-pro-preview-stream"
>
