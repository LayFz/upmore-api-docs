---
title: "FLUX.1.1 [pro]"
description: "通过 Upmore API 调用 Black Forest Labs FLUX.1.1 [pro] 文生图模型。"
---

FLUX.1.1 [pro] 是 Black Forest Labs 推出的高质量文生图模型，通过 Upmore 提供。API 为**同步调用** — 直接返回 Base64 编码的图片数据。
...
<Card
  title="API 参考"
  icon="code"
  href="/zh/api-reference/model-api/blackforestlabs/flux-1-1-pro"
>
