...
Kling V3 Omni 是快手最新的视频生成模型，通过 Upmore API 提供服务。Omni 模型可通过 Prompt 结合元素、图片、视频等内容实现多种能力 — 支持文生视频、图生视频、视频编辑、多镜头分镜和同步音效生成。
...
<Card
  title="API 参考"
  icon="code"
  href="/zh/api-reference/model-api/kuaishou/kling-v3-omni"
>
