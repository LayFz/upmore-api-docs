---
title: "Kimi-K2.5"
description: "通过 AnyFast OpenAI 兼容接口调用月之暗面 Kimi-K2.5 对话模型，快速、强大且易于集成。"
---

Kimi-K2.5 是月之暗面（MoonShot）推出的对话模型，通过 AnyFast 以 OpenAI 兼容接口提供。
...
<Card
  title="API 参考"
  icon="code"
  href="/zh/api-reference/model-api/moonshot/kimi-k2-5"
>
