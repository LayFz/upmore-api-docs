---
title: "MiniMax M2.5"
description: "通过 AnyFast OpenAI 兼容接口调用 MiniMax M2.5 对话模型，快速、强大且易于集成。"
---

MiniMax M2.5 是通过 AnyFast 以 OpenAI 兼容接口提供的对话模型。
...
<Card
  title="API 参考"
  icon="code"
  href="/zh/api-reference/model-api/minimax/minimax-m2-5"
>
