...
Claude Sonnet 4.5 Thinking 是 Claude Sonnet 4.5 的扩展思维版本，通过 Upmore 以 OpenAI 兼容接口提供服务。结合 Sonnet 4.5 在速度和能力之间的出色平衡，默认启用逐步内部推理，在复杂任务上显著提升准确率，同时保持快速响应。
...
<Card
  title="API 参考"
  icon="code"
  href="/zh/api-reference/model-api/anthropic/claude-sonnet-4-5-20250929-thinking"
>
