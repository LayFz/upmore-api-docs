---
title: "豆包兼容接口"
description: "通过火山方舟 Ark SDK 使用 Upmore 的 /v1/chat/completions 和 /v1/responses 端点访问豆包模型。"
---

Upmore 兼容火山方舟 Ark Chat API。如果你已在使用 Ark SDK 或直接调用 Ark API，只需更改 base URL 即可切换到 Upmore，无需重写代码。
