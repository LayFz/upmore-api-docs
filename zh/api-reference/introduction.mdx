---
title: "介绍"
description: "Upmore API 的 Base URL、认证方式、请求格式及错误处理。"
icon: "book-open"
---
...
Upmore 使用 Bearer Token 认证。在每个请求的 `Authorization` 头中包含你的 API Key：

```
Authorization: Bearer YOUR_API_KEY
```

你可以在 [API 密钥](https://api.upmore.net/keys) 中生成和管理 API Key。
...
Upmore 兼容 OpenAI SDK，只需更改 `base_url` 即可使用：
